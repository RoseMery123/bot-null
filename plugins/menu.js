...
fahrilbotz versi:1.5.0
Best WhatsApp Bot`.trim(),
"buttonText": "𝗸𝗹𝗶𝗸 𝗱𝗶𝘀𝗶𝗻𝗶",
              ...
              "rows": [
                {
                  ...
                  "rowId": ".? image"
                   ...
                   "title": "💰sewabot",
                   "description": "Untuk kamu yang ingin melihat daftar harga sewabot",
                   "rowId": ".sewa"
                }, {
                  "title": "🎇 Stiker",
                  ...
                  "title": "😂 fun",
                  "description": "Menu bahagia",
                  "rowId": ".? fun"
                }, {
                   "title": "💲donasi",
                   "description": "jangan lupa donasi",
                   "rowId": ".donasi" 
                }, {
                  "title": "📂 Database",
                  ...
                  "title": "‼️rules bot",
                  "description": "rules bot! melanggar akan di ban ",
                  "rowId": ".rules"
                }, {
                  "title": "🤖 Jadi Bot",
                  "description": "numpang",
    ...
    let after = conn.menu.after || (conn.user.jid == global.conn.user.jid ? '' : `host by https://wa.me/${global.conn.user.jid.split`@`[0]}`) + defaultMenu.after
    let _text = [
      before,
